    ...
    <div className="flex min-h-[70vh] items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-full bg-primary px-5 py-2.5 text-sm font-medium text-primary-foreground transition-opacity hover:opacity-85"
          >
            Go home
          </Link>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Aditya Kandwal — Digital Marketer & Visual Storyteller" },
      {
        name: "description",
        content:
          "Portfolio of Aditya Kandwal, digital and performance marketing professional and multimedia creator based in Bhopal, India.",
      },
      { name: "author", content: "Aditya Kandwal" },
