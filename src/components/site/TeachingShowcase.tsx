...
/**
 * Full-bleed independent showcase for case study 04 — Marketing Education.
 * Large editorial typography + the teaching media carousel.
 */
export function TeachingShowcase() {
  ...
  return (
    <section
      ...
      aria-label="Case study 04 — Marketing Education"
    ...
    >
      <div className="mx-auto max-w-6xl px-5 py-24 sm:px-8 sm:py-36">
        <Reveal className="flex flex-wrap items-end justify-between gap-6 border-b border-border pb-8">
          <p className="eyebrow">Case Study 04 — {project.category}</p>
